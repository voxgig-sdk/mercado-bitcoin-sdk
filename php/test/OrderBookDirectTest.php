...
class OrderBookDirectTest extends TestCase
{
    public function test_direct_load_order_book(): void
    {
        $setup = order_book_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-order_book", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
