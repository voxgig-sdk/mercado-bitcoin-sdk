...
// MercadoBitcoin SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (MercadoBitcoinSDK::test)
...
{
    private const SDK_CLASS = 'MercadoBitcoinSDK';
    ...
    private const SDK_BASE = 'mercadobitcoin_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../mercadobitcoin_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
