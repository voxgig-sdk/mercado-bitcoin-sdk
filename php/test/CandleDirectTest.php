...
class CandleDirectTest extends TestCase
{
    public function test_direct_load_candle(): void
    {
        $setup = candle_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-candle", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
