...
class TradeDirectTest extends TestCase
{
    public function test_direct_load_trade(): void
    {
        $setup = trade_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-trade", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
