...
// MercadoBitcoin SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = MercadoBitcoinOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(MercadoBitcoinOmni::structfix($now, Struct::undef()))
                        !== json_encode(MercadoBitcoinOmni::structfix($val, Struct::undef()))) {
