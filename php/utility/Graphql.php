...
// MercadoBitcoin SDK utility: graphql
//
...
class MercadoBitcoinGraphql
{
    ...
    // equivalent.
    public static function body(MercadoBitcoinContext $ctx): mixed
    {
    ...
    public static function errors(MercadoBitcoinContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
