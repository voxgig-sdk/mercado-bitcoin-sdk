...
// MercadoBitcoin SDK utility: param

require_once __DIR__ . '/../core/Helpers.php';

class MercadoBitcoinParam
{
    public static function call(MercadoBitcoinContext $ctx, mixed $paramdef): mixed
    {
        $point = $ctx->point;
        $spec = $ctx->spec;
        $match_val = $ctx->match;
        ...
        $akey = '';
        if ($point) {
            $alias_map = MercadoBitcoinHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'alias'));
            if ($alias_map) {
