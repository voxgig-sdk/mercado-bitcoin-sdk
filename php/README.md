...
The PHP SDK for the MercadoBitcoin API. Provides an entity-oriented interface using PHP conventions.
...
```php
[$result, $err] = $client->Balance(null)->list(null, null);
...
[$result, $err] = $client->MercadoBitcoin(null)->load(
    ["id" => "test01"], null
);
