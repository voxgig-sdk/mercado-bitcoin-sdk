...
// MercadoBitcoin SDK audit feature
...
class MercadoBitcoinAuditFeature extends MercadoBitcoinBaseFeature
{
    ...
    private function _emit(MercadoBitcoinContext $ctx, string $outcome): void
    {
