...
// MercadoBitcoin SDK proxy feature
...
class MercadoBitcoinProxyFeature extends MercadoBitcoinBaseFeature
{
    ...
    public function init(MercadoBitcoinContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (MercadoBitcoinContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
