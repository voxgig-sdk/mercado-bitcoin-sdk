...
// MercadoBitcoin SDK netsim feature
...
class MercadoBitcoinNetsimFeature extends MercadoBitcoinBaseFeature
{
    ...
    private function _simulate(MercadoBitcoinContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(MercadoBitcoinContext $ctx, array $applied): void
    {
        $client = $this->client;
