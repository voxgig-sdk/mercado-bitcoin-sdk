...
// MercadoBitcoin SDK debug feature
...
class MercadoBitcoinDebugFeature extends MercadoBitcoinBaseFeature
{
    ...
    private function _finish(MercadoBitcoinContext $ctx, bool $ok): void
    {
