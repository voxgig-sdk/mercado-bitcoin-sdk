...
// MercadoBitcoin SDK metrics feature
...
class MercadoBitcoinMetricsFeature extends MercadoBitcoinBaseFeature
{
    ...
    private function _record(MercadoBitcoinContext $ctx, bool $ok): void
    {
