...
// MercadoBitcoin SDK timeout feature
...
class MercadoBitcoinTimeoutFeature extends MercadoBitcoinBaseFeature
{
    ...
    private function _with_timeout(MercadoBitcoinContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(MercadoBitcoinContext $_ctx, float $ms): void
    {
        $client = $this->client;
