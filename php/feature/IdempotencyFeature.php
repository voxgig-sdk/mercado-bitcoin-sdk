...
// MercadoBitcoin SDK idempotency feature
...
class MercadoBitcoinIdempotencyFeature extends MercadoBitcoinBaseFeature
{
    ...
    private function _mutating(MercadoBitcoinContext $ctx): bool
    {
