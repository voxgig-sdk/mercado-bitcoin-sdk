...
// MercadoBitcoin SDK streaming feature
...
class MercadoBitcoinStreamingFeature extends MercadoBitcoinBaseFeature
{
    ...
    private function _iterate(MercadoBitcoinResult $result): \Generator
    {
    ...
    private function _streamable(MercadoBitcoinContext $ctx): bool
    {
