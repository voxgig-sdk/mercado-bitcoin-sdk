...
// MercadoBitcoin SDK telemetry feature
...
class MercadoBitcoinTelemetryFeature extends MercadoBitcoinBaseFeature
{
    ...
    private function _close(MercadoBitcoinContext $ctx, bool $ok): void
    {
