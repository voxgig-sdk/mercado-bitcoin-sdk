...
class TradeEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new TradeEntity($this->_client, $opts);
    }

    /**
     * @param Trade|array $args Trade data (assoc-array) to store.
     */
    ...
    /**
     * @return Trade|array The current Trade data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Trade fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Trade fields).
     */
     ...
     * Load a single Trade.
     *
     * @param TradeLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed TradeLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Trade|array The loaded Trade as an assoc-array at the
