...
class WithdrawalEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new WithdrawalEntity($this->_client, $opts);
    }

    /**
     * @param Withdrawal|array $args Withdrawal data (assoc-array) to store.
     */
    ...
    /**
     * @return Withdrawal|array The current Withdrawal data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Withdrawal fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Withdrawal fields).
     */
     ...
     *
     * @param WithdrawalCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed WithdrawalCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Withdrawal|array The created Withdrawal as an assoc-array at the
