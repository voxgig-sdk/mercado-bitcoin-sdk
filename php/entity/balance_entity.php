...
class BalanceEntity
{
     ...
     *
     * @param BalanceListMatch|array|null $reqmatch Match filter (any subset
     *   of Balance fields) as an assoc-array; BalanceListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Balance[]|array A list of Balance items as assoc-arrays at
