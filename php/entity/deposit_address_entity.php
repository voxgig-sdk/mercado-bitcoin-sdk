...
class DepositAddressEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new DepositAddressEntity($this->_client, $opts);
    }

    /**
     * @param DepositAddress|array $args DepositAddress data (assoc-array) to store.
     */
    ...
    /**
     * @return DepositAddress|array The current DepositAddress data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of DepositAddress fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of DepositAddress fields).
     */
     ...
     *
     * @param DepositAddressLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed DepositAddressLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return DepositAddress|array The loaded DepositAddress as an assoc-array at the
