...
class CandleEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new CandleEntity($this->_client, $opts);
    }

    /**
     * @param Candle|array $args Candle data (assoc-array) to store.
     */
    ...
    /**
     * @return Candle|array The current Candle data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Candle fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Candle fields).
     */
     ...
     *
     * @param CandleLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed CandleLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Candle|array The loaded Candle as an assoc-array at the
