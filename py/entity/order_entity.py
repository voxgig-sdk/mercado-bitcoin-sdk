...
class OrderEntity:
    ...
    def load(self, reqmatch: OrderLoadMatch, ctrl=None) -> Order:
    ...
    def list(self, reqmatch: OrderListMatch, ctrl=None) -> list[Order]:
        utility = self._utility
        ctx = utility.make_context({
            "opname": "list",
            "ctrl": ctrl,
    ...
    def remove(self, reqmatch: OrderRemoveMatch, ctrl=None) -> Order:
        utility = self._utility
        ctx = utility.make_context({
            "opname": "remove",
            "ctrl": ctrl,
