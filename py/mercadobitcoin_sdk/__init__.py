...
from mercadobitcoin_sdk.utility import register

# Load features
from mercadobitcoin_sdk.feature.base_feature import MercadoBitcoinBaseFeature
from mercadobitcoin_sdk.features import _has_feature, _make_feature
...
class MercadoBitcoinSDK:
    ...
    def get_utility(self):
        return MercadoBitcoinUtility.copy(self._utility)
    ...
    def _op_denied(self, op):
        ...
        return {
            "ok": False,
            "err": Exception(
                "MercadoBitcoinSDK: " + op + ": operation not allowed by"
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("MercadoBitcoinSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Balance(self, data=None) -> "BalanceEntity":
        ...
        from mercadobitcoin_sdk.entity.balance_entity import BalanceEntity
    ...
    def Candle(self, data=None) -> "CandleEntity":
        ...
        from mercadobitcoin_sdk.entity.candle_entity import CandleEntity
    ...
    def DepositAddress(self, data=None) -> "DepositAddressEntity":
        ...
        from mercadobitcoin_sdk.entity.deposit_address_entity import DepositAddressEntity
    ...
    def Order(self, data=None) -> "OrderEntity":
        ...
        from mercadobitcoin_sdk.entity.order_entity import OrderEntity
    ...
    def OrderBook(self, data=None) -> "OrderBookEntity":
        ...
        from mercadobitcoin_sdk.entity.order_book_entity import OrderBookEntity
    ...
    def Ticker(self, data=None) -> "TickerEntity":
        ...
        from mercadobitcoin_sdk.entity.ticker_entity import TickerEntity
        return TickerEntity(self, data)


    def Trade(self, data=None) -> "TradeEntity":
        """Entity factory: client.Trade().list() / client.Trade().load({"id": ...})."""
        from mercadobitcoin_sdk.entity.trade_entity import TradeEntity
    ...
    def Withdrawal(self, data=None) -> "WithdrawalEntity":
        ...
        from mercadobitcoin_sdk.entity.withdrawal_entity import WithdrawalEntity
