...
class DepositAddressEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return DepositAddressEntity(self._client, opts)
    ...
    def data_get(self) -> DepositAddress:
    ...
    def match_get(self) -> DepositAddress:
    ...
    def load(self, reqmatch=None, ctrl=None) -> DepositAddress:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.DepositAddress().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
