...
class WithdrawalEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return WithdrawalEntity(self._client, opts)
    ...
    def create(self, reqdata: WithdrawalCreateData, ctrl=None) -> Withdrawal:
        utility = self._utility
