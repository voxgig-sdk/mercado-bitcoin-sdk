# MercadoBitcoin SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions MercadoBitcoinSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both MercadoBitcoinSDK(...) and MercadoBitcoinSDK.test(...) become
#      MercadoBitcoinSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "mercadobitcoin_sdk"
_SDK_CLASS = "MercadoBitcoinSDK"
