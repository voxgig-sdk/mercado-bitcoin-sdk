...
describe("CandleDirect", function()
  it("should direct-load-candle", function()
    local setup = candle_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-candle", setup.live and "live" or "unit")
...
function candle_direct_setup(mockres)
