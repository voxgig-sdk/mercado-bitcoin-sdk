...
describe("BalanceDirect", function()
  it("should direct-list-balance", function()
    local setup = balance_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-balance", setup.live and "live" or "unit")
