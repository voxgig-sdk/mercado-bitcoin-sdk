...
describe("DepositAddressEntity", function()
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set MERCADO_BITCOIN_TEST_DEPOSIT_ADDRESS_ENTID JSON to run live")
      return
    end
...
function deposit_address_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("MERCADO_BITCOIN_TEST_DEPOSIT_ADDRESS_ENTID")
