...
describe("TradeDirect", function()
  it("should direct-load-trade", function()
    local setup = trade_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-trade", setup.live and "live" or "unit")
...
function trade_direct_setup(mockres)
