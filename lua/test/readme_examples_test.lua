...
local SDK_MODULE = "mercado-bitcoin_sdk"
...
-- data to return.
local TEST_SEED = '{ entity = { ["balance"] = { ["test01"] = { id = "test01" } }, ["candle"] = { ["test01"] = { id = "test01" } }, ["deposit_address"] = { ["test01"] = { id = "test01" } }, ["order"] = { ["test01"] = { id = "test01" } }, ["order_book"] = { ["test01"] = { id = "test01" } }, ["ticker"] = { ["test01"] = { id = "test01" } }, ["trade"] = { ["test01"] = { id = "test01" } }, ["withdrawal"] = { ["test01"] = { id = "test01" } } } }'
