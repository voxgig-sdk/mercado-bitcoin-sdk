...
describe("OrderBookEntity", function()
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set MERCADO_BITCOIN_TEST_ORDER_BOOK_ENTID JSON to run live")
      return
    end
...
function order_book_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("MERCADO_BITCOIN_TEST_ORDER_BOOK_ENTID")
