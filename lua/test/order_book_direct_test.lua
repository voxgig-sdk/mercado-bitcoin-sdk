...
describe("OrderBookDirect", function()
  it("should direct-load-order_book", function()
    local setup = order_book_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-order_book", setup.live and "live" or "unit")
...
function order_book_direct_setup(mockres)
