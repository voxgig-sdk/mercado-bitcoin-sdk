...
describe("WithdrawalEntity", function()
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set MERCADO_BITCOIN_TEST_WITHDRAWAL_ENTID JSON to run live")
      return
    end
    ...
    assert.is_nil(err)
    withdrawal_ref01_data = helpers.to_map(type(withdrawal_ref01_data_result) == 'table' and withdrawal_ref01_data_result.data_get and withdrawal_ref01_data_result:data_get() or withdrawal_ref01_data_result)
...
function withdrawal_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("MERCADO_BITCOIN_TEST_WITHDRAWAL_ENTID")
