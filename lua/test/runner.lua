...
function runner.env_override(m)
  local live = runner.getenv("MERCADOBITCOIN_TEST_LIVE")
  local override = runner.getenv("MERCADOBITCOIN_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("MERCADOBITCOIN_TEST_EXPLAIN")
