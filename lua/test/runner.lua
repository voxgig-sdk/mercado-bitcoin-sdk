...
function runner.env_override(m)
  local live = runner.getenv("MERCADO_BITCOIN_TEST_LIVE")
  local override = runner.getenv("MERCADO_BITCOIN_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("MERCADO_BITCOIN_TEST_EXPLAIN")
