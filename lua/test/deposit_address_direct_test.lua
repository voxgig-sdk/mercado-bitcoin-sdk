...
describe("DepositAddressDirect", function()
  it("should direct-load-deposit_address", function()
    local setup = deposit_address_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-deposit_address", setup.live and "live" or "unit")
...
function deposit_address_direct_setup(mockres)
