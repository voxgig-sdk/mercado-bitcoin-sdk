-- MercadoBitcoin SDK DepositAddress entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local DepositAddressEntity = {}
DepositAddressEntity.__index = DepositAddressEntity


function DepositAddressEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, DepositAddressEntity)
  self._name = "deposit_address"
  self._client = client
...
function DepositAddressEntity:get_name()
  return self._name
end


function DepositAddressEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return DepositAddressEntity.new(self._client, opts)
end
...
function DepositAddressEntity:mark_deleted()
  self._deleted = true
end


function DepositAddressEntity:deleted()
  return true == self._deleted
end


function DepositAddressEntity:data_set(args)
  if args ~= nil then
...
function DepositAddressEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function DepositAddressEntity:match_set(args)
  if args ~= nil then
...
function DepositAddressEntity:match_get()
...
function DepositAddressEntity:stream(action, args, callopts)
...
function DepositAddressEntity:_run_op(ctx, post_done)
  local utility = self._utility
