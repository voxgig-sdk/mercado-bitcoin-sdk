-- MercadoBitcoin SDK OrderBook entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local OrderBookEntity = {}
OrderBookEntity.__index = OrderBookEntity


function OrderBookEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, OrderBookEntity)
  self._name = "order_book"
  self._client = client
...
function OrderBookEntity:get_name()
  return self._name
end


function OrderBookEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return OrderBookEntity.new(self._client, opts)
end
...
function OrderBookEntity:mark_deleted()
  self._deleted = true
end


function OrderBookEntity:deleted()
  return true == self._deleted
end


function OrderBookEntity:data_set(args)
  if args ~= nil then
...
function OrderBookEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function OrderBookEntity:match_set(args)
  if args ~= nil then
...
function OrderBookEntity:match_get()
...
function OrderBookEntity:stream(action, args, callopts)
...
function OrderBookEntity:_run_op(ctx, post_done)
  local utility = self._utility
