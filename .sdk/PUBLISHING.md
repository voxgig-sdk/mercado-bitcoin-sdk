...
|---|---|---|
| `ts/` | @voxgig-sdk/mercado-bitcoin-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/mercado-bitcoin-sdk \
      --repository voxgig-sdk/mercado-bitcoin-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/mercado-bitcoin-sdk` shows it, and
`npm trust revoke @voxgig-sdk/mercado-bitcoin-sdk --id=<id>` removes it.
