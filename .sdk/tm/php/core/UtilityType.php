...
// MercadoBitcoin SDK utility type

class MercadoBitcoinUtility
{
    ...
    public static function copy(MercadoBitcoinUtility $src): MercadoBitcoinUtility
    {
        $u = new MercadoBitcoinUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
