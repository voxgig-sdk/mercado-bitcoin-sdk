...
// MercadoBitcoin SDK utility: fetcher

class MercadoBitcoinFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; MercadoBitcoinSDK/1.0)';
    ...
    public static function call(MercadoBitcoinContext $ctx, string $fullurl, array $fetchdef): array
    {
