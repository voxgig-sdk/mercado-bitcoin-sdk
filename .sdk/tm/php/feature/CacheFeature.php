...
// MercadoBitcoin SDK cache feature
...
class MercadoBitcoinCacheFeature extends MercadoBitcoinBaseFeature
{
    ...
    private function _through(MercadoBitcoinContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
