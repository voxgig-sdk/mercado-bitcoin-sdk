...
// MercadoBitcoin SDK ratelimit feature
...
class MercadoBitcoinRatelimitFeature extends MercadoBitcoinBaseFeature
{
    ...
    private function _acquire(MercadoBitcoinContext $ctx): void
    {
    ...
    private function _track(MercadoBitcoinContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
