...
// MercadoBitcoin SDK clienttrack feature
...
class MercadoBitcoinClienttrackFeature extends MercadoBitcoinBaseFeature
{
    ...
    public function PostConstruct(MercadoBitcoinContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'MercadoBitcoin-SDK';
