...
// MercadoBitcoin SDK rbac feature
...
class MercadoBitcoinRbacFeature extends MercadoBitcoinBaseFeature
{
    ...
    private function _required(MercadoBitcoinContext $ctx): ?string
    {
    ...
    private function _reject(MercadoBitcoinContext $ctx, string $required): void
    {
    ...
    private function _track(MercadoBitcoinContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
