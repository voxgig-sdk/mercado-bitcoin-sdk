...
func NewTradeEntity(client *core.MercadoBitcoinSDK, entopts map[string]any) *TradeEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *TradeEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *TradeEntity) List(_ map[string]any, _ map[string]any) (any, error) {
