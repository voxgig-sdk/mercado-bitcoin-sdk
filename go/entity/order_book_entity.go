...
func NewOrderBookEntity(client *core.MercadoBitcoinSDK, entopts map[string]any) *OrderBookEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *OrderBookEntity) GetName() string { return e.name }
...
func (e *OrderBookEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *OrderBookEntity) Deleted() bool {
	return e.deleted
}


func (e *OrderBookEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewOrderBookEntity(e.client, opts)
}

func (e *OrderBookEntity) Data(args ...any) any {
...
func (e *OrderBookEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an OrderBook; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *OrderBookEntity) DataTyped(data ...OrderBook) OrderBook {
	if len(data) > 0 {
		return typedFrom[OrderBook](e.Data(asMap(data[0])))
	}
	return typedFrom[OrderBook](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through OrderBook (all fields
// optional at the wire level).
func (e *OrderBookEntity) MatchTyped(match ...OrderBook) OrderBook {
	if len(match) > 0 {
		return typedFrom[OrderBook](e.Match(asMap(match[0])))
	}
	return typedFrom[OrderBook](e.Match())
}
...
func (e *OrderBookEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *OrderBookEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// OrderBookLoadMatch and returns an OrderBook. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *OrderBookEntity) LoadTyped(reqmatch OrderBookLoadMatch, ctrl map[string]any) (OrderBook, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return OrderBook{}, err
	}
	return typedFrom[OrderBook](res), nil
}



func (e *OrderBookEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *OrderBookEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *OrderBookEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *OrderBookEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *OrderBookEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
