...
func NewCandleEntity(client *core.MercadoBitcoinSDK, entopts map[string]any) *CandleEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *CandleEntity) GetName() string { return e.name }
...
func (e *CandleEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *CandleEntity) Deleted() bool {
	return e.deleted
}


func (e *CandleEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewCandleEntity(e.client, opts)
}

func (e *CandleEntity) Data(args ...any) any {
...
func (e *CandleEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
func (e *CandleEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *CandleEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *CandleEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *CandleEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *CandleEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *CandleEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
