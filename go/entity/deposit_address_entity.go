...
type DepositAddressEntity struct {
	name    string
...
func NewDepositAddressEntity(client *core.MercadoBitcoinSDK, entopts map[string]any) *DepositAddressEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *DepositAddressEntity) GetName() string { return e.name }
...
func (e *DepositAddressEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *DepositAddressEntity) Deleted() bool {
	return e.deleted
}


func (e *DepositAddressEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewDepositAddressEntity(e.client, opts)
}

func (e *DepositAddressEntity) Data(args ...any) any {
...
func (e *DepositAddressEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an DepositAddress; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *DepositAddressEntity) DataTyped(data ...DepositAddress) DepositAddress {
	if len(data) > 0 {
		return typedFrom[DepositAddress](e.Data(asMap(data[0])))
	}
	return typedFrom[DepositAddress](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through DepositAddress (all fields
// optional at the wire level).
func (e *DepositAddressEntity) MatchTyped(match ...DepositAddress) DepositAddress {
	if len(match) > 0 {
		return typedFrom[DepositAddress](e.Match(asMap(match[0])))
	}
	return typedFrom[DepositAddress](e.Match())
}
...
func (e *DepositAddressEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *DepositAddressEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// DepositAddressLoadMatch and returns an DepositAddress. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *DepositAddressEntity) LoadTyped(reqmatch DepositAddressLoadMatch, ctrl map[string]any) (DepositAddress, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return DepositAddress{}, err
	}
	return typedFrom[DepositAddress](res), nil
}



func (e *DepositAddressEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *DepositAddressEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *DepositAddressEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *DepositAddressEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *DepositAddressEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
