...
func NewWithdrawalEntity(client *core.MercadoBitcoinSDK, entopts map[string]any) *WithdrawalEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *WithdrawalEntity) GetName() string { return e.name }
...
func (e *WithdrawalEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *WithdrawalEntity) Deleted() bool {
	return e.deleted
}


func (e *WithdrawalEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewWithdrawalEntity(e.client, opts)
}

func (e *WithdrawalEntity) Data(args ...any) any {
...
func (e *WithdrawalEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Withdrawal; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *WithdrawalEntity) DataTyped(data ...Withdrawal) Withdrawal {
	if len(data) > 0 {
		return typedFrom[Withdrawal](e.Data(asMap(data[0])))
	}
	return typedFrom[Withdrawal](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Withdrawal (all fields
// optional at the wire level).
func (e *WithdrawalEntity) MatchTyped(match ...Withdrawal) Withdrawal {
	if len(match) > 0 {
		return typedFrom[Withdrawal](e.Match(asMap(match[0])))
	}
	return typedFrom[Withdrawal](e.Match())
}
...
func (e *WithdrawalEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *WithdrawalEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *WithdrawalEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *WithdrawalEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// WithdrawalCreateData and returns an Withdrawal. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *WithdrawalEntity) CreateTyped(reqdata WithdrawalCreateData, ctrl map[string]any) (Withdrawal, error) {
	res, err := e.Create(asMap(reqdata), ctrl)
	if err != nil {
		return Withdrawal{}, err
	}
	return typedFrom[Withdrawal](res), nil
}



func (e *WithdrawalEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *WithdrawalEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *WithdrawalEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
