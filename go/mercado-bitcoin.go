...
// instead of `sdk.NewMercadoBitcoinSDK(nil)` / `sdk.TestSDK(nil, nil)`
// for the common no-options case.
func New() *MercadoBitcoinSDK  { return NewMercadoBitcoinSDK(nil) }
func Test() *MercadoBitcoinSDK { return TestSDK(nil, nil) }
