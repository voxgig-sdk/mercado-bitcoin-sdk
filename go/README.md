...
## Install
```bash
go get github.com/voxgig-sdk/mercado-bitcoin-sdk
```
...
```bash
go mod edit -replace github.com/voxgig-sdk/mercado-bitcoin-sdk=../path/to/github.com/voxgig-sdk/mercado-bitcoin-sdk
```
...
```
github.com/voxgig-sdk/mercado-bitcoin-sdk/
...
The root package (`github.com/voxgig-sdk/mercado-bitcoin-sdk`) re-exports everything needed
