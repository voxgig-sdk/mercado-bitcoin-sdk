...
const testSeed = `map[string]any{"entity": map[string]any{"balance": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "candle": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "deposit_address": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "order": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "order_book": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "ticker": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "trade": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "withdrawal": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
