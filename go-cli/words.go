...
func registerSDKWords(r *eng.Registry, client *sdk.MercadoBitcoinSDK) {
...
func runOp(client *sdk.MercadoBitcoinSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
