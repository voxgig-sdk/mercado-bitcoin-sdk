...
AQL-driven CLI and REPL for the MercadoBitcoin SDK. Positional arguments are
...
```sh
go build -o mercado-bitcoin-cli ./...
```
...
./mercado-bitcoin-cli load 1 balance
./mercado-bitcoin-cli load '{id:1}' balance
