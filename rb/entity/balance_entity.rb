# MercadoBitcoin SDK Balance entity
...
class BalanceEntity
  ...
  #
  # @param reqmatch [BalanceListMatch, Hash, nil] match filter (any subset of
  #   Balance fields); defaults to nil, treated as an empty match that lists all.
