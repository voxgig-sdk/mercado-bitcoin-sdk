...
class TickerEntity
  ...
  #   as an empty match, so client.Ticker.load works with no args).
  ...
  #
  # @param reqmatch [TickerListMatch, Hash, nil] match filter (any subset of
  #   Ticker fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
