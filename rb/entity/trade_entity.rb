# MercadoBitcoin SDK Trade entity
...
class TradeEntity
  ...
  # @return [Trade, Hash] the current Trade data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Trade fields)
  def match_get
  ...
  # Load a single Trade.
  #
  # @param reqmatch [TradeLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.Trade.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [Trade, Hash] the loaded Trade; raises MercadoBitcoinError on failure
