...
#      offline in seeded test mode (MercadoBitcoinSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "MercadoBitcoin_sdk.rb")
  SDK_CLASS = "MercadoBitcoinSDK"
