...
class OrderBookEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set MERCADOBITCOIN_TEST_ORDER_BOOK_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def order_book_basic_setup(extra)
  ...
  entid_env_raw = ENV["MERCADOBITCOIN_TEST_ORDER_BOOK_ENTID"]
