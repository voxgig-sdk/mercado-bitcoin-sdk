// Command MercadoBitcoin-mcp is an MCP server exposing the MercadoBitcoin
// SDK as MCP tools.
//
// Two tools are registered:
//
//	MercadoBitcoin_list  — list records of an entity
//	MercadoBitcoin_load  — load a single record of an entity
//
