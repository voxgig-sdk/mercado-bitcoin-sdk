...
(0, node_test_1.describe)('CandleDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-candle', async (t) => {
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-candle', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['MERCADO_BITCOIN_TEST_CANDLE_ENTID'];
...
//# sourceMappingURL=CandleDirect.test.js.map