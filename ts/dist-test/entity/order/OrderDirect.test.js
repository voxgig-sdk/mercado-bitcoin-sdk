...
(0, node_test_1.describe)('OrderDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.MercadoBitcoinSDK({
    ...
    (0, node_test_1.test)('direct-load-order', async (t) => {
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-order', setup.live))
            return;
    ...
    (0, node_test_1.test)('direct-list-order', async (t) => {
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-order', setup.live))
            return;
        const { client, calls } = setup;
        const params = {};
        const query = {};
...
function directSetup(mockres) {
    ...
    const env = (0, utility_1.envOverride)({
        'MERCADO_BITCOIN_TEST_ORDER_ENTID': {},
    ...
    if (live) {
        ...
        const client = new __1.MercadoBitcoinSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), {
            apikey: env.MERCADO_BITCOIN_APIKEY,
        }));
        let idmap = env['MERCADO_BITCOIN_TEST_ORDER_ENTID'];
    ...
    const client = new __1.MercadoBitcoinSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=OrderDirect.test.js.map