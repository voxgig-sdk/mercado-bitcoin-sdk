...
(0, node_test_1.describe)('OrderEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        if (setup.syntheticOnly) {
            t.skip('live entity test uses synthetic IDs from fixture — set MERCADO_BITCOIN_TEST_ORDER_ENTID JSON to run live');
            return;
        }
        ...
        (0, node_assert_1.default)(null != order_ref01_data.id);
        // LIST
        const order_ref01_match = {};
        const order_ref01_list = (await order_ref01_ent.list(order_ref01_match)).map((e) => e.data());
        (0, node_assert_1.default)(!isempty(select(order_ref01_list, { id: order_ref01_data.id })));
        // LOAD
        const order_ref01_match_dt0 = {};
        ...
        (0, node_assert_1.default)(order_ref01_data_dt0.id === order_ref01_data.id);
        // REMOVE
        const order_ref01_match_rm0 = { id: order_ref01_data.id };
        await order_ref01_ent.remove(order_ref01_match_rm0);
        // LIST
        const order_ref01_match_rt0 = {};
        const order_ref01_list_rt0 = (await order_ref01_ent.list(order_ref01_match_rt0)).map((e) => e.data());
        (0, node_assert_1.default)(isempty(select(order_ref01_list_rt0, { id: order_ref01_data.id })));
    });
});
function basicSetup(extra) {
    ...
    const idmapEnvVal = process.env['MERCADO_BITCOIN_TEST_ORDER_ENTID'];
    ...
    idmap = env['MERCADO_BITCOIN_TEST_ORDER_ENTID'];
