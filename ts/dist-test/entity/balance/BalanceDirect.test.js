...
(0, node_test_1.describe)('BalanceDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-balance', async (t) => {
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-balance', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['MERCADO_BITCOIN_TEST_BALANCE_ENTID'];
