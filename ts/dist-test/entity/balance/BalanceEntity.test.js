...
(0, node_test_1.describe)('BalanceEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        if (setup.syntheticOnly) {
            t.skip('live entity test uses synthetic IDs from fixture — set MERCADO_BITCOIN_TEST_BALANCE_ENTID JSON to run live');
            return;
        }
...
function basicSetup(extra) {
    ...
    const idmapEnvVal = process.env['MERCADO_BITCOIN_TEST_BALANCE_ENTID'];
    ...
    idmap = env['MERCADO_BITCOIN_TEST_BALANCE_ENTID'];
