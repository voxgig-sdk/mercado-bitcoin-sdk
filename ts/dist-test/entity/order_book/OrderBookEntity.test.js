...
(0, node_test_1.describe)('OrderBookEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['load']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'order_book.' + op, live))
                return;
        }
        ...
        let order_book_ref01_data = Object.values(setup.data.existing.order_book)[0];
...
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/order_book/OrderBookTestData.json');
    ...
    let idmap = transform(['order_book01', 'order_book02', 'order_book03', 'orderbook01', 'orderbook02', 'orderbook03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
...
//# sourceMappingURL=OrderBookEntity.test.js.map