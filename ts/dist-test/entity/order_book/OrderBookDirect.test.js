...
(0, node_test_1.describe)('OrderBookDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-order_book', async (t) => {
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-order_book', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["symbol01"]))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['MERCADO_BITCOIN_TEST_ORDER_BOOK_ENTID'];
...
//# sourceMappingURL=OrderBookDirect.test.js.map