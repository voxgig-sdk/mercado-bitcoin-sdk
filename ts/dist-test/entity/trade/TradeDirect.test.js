...
(0, node_test_1.describe)('TradeDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-trade', async (t) => {
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-trade', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['MERCADO_BITCOIN_TEST_TRADE_ENTID'];
...
//# sourceMappingURL=TradeDirect.test.js.map