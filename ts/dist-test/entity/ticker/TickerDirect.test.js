...
(0, node_test_1.describe)('TickerDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-ticker', async (t) => {
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-ticker', setup.live))
            return;
    ...
    (0, node_test_1.test)('direct-list-ticker', async (t) => {
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-ticker', setup.live))
            return;
        const { client, calls } = setup;
        const params = {};
        const query = {};
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['MERCADO_BITCOIN_TEST_TICKER_ENTID'];
...
//# sourceMappingURL=TickerDirect.test.js.map