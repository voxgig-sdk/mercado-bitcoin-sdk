...
(0, node_test_1.describe)('TickerEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['list', 'load']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'ticker.' + op, live))
                return;
        }
        ...
        const ticker_ref01_match = {};
        const ticker_ref01_list = (await ticker_ref01_ent.list(ticker_ref01_match)).map((e) => e.data());
        // LOAD
        const ticker_ref01_match_dt0 = {};
        ...
        (0, node_assert_1.default)(ticker_ref01_data_dt0.id === ticker_ref01_data.id);
    });
});
