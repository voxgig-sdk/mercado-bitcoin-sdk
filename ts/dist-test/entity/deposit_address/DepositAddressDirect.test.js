...
(0, node_test_1.describe)('DepositAddressDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-deposit_address', async (t) => {
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-deposit_address', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['MERCADO_BITCOIN_TEST_DEPOSIT_ADDRESS_ENTID'];
...
//# sourceMappingURL=DepositAddressDirect.test.js.map