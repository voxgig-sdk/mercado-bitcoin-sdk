...
describe('CandleDirect', async () => {
  ...
  test('direct-load-candle', async (t: any) => {
    const setup = directSetup({ id: 'direct01' })
    if (maybeSkipControl(t, 'direct', 'direct-load-candle', setup.live)) return
...
function directSetup(mockres?: any) {
  ...
  if (live) {
    ...
    let idmap: any = env['MERCADO_BITCOIN_TEST_CANDLE_ENTID']
