...
describe('DepositAddressEntity', async () => {
  ...
  test('basic', async (t) => {
    ...
    for (const op of ['load']) {
      if (maybeSkipControl(t, 'entityOp', 'deposit_address.' + op, live)) return
    }
    ...
    let deposit_address_ref01_data = Object.values(setup.data.existing.deposit_address)[0] as any
...
function basicSetup(extra?: any) {
  ...
  const entityDataFile =
    Path.resolve(__dirname, 
      '../../../../.sdk/test/entity/deposit_address/DepositAddressTestData.json')
