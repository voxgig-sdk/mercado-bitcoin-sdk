...
describe('DepositAddressDirect', async () => {
  ...
  test('direct-load-deposit_address', async (t: any) => {
    const setup = directSetup({ id: 'direct01' })
    if (maybeSkipControl(t, 'direct', 'direct-load-deposit_address', setup.live)) return
...
function directSetup(mockres?: any) {
  ...
  if (live) {
    ...
    let idmap: any = env['MERCADOBITCOIN_TEST_DEPOSIT_ADDRESS_ENTID']
