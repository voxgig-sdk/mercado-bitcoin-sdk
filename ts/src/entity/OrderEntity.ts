...
class OrderEntity extends MercadoBitcoinEntityBase<Order> {
  ...
  make(this: OrderEntity) {
    return new OrderEntity(this._client, this.entopts())
  }



  async load(this: any, reqmatch?: OrderLoadMatch, ctrl?: Control): Promise<OrderEntity> {
  ...
  async list(this: any, reqmatch?: OrderListMatch, ctrl?: Control): Promise<OrderEntity[]> {
  ...
  async create(this: any, reqdata?: OrderCreateData, ctrl?: Control): Promise<OrderEntity> {
  ...
  async remove(
    this: any, reqmatch?: OrderRemoveMatch, ctrl?: Control,
  ): Promise<OrderEntity> {
    ...
    try {
      ...
      if (err) {
        ...
        // Off-happy-path (throw disabled): typed as any so the method's
        // Promise<OrderEntity> return stays clean under strict null checks.
        return undefined as any
      }
    }
  }
