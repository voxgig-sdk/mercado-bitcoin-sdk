...
class MercadoBitcoinSDK {
  ...
  async graphql(query: string, variables?: any, ctrl?: any) {
    ...
    if (null != errors && Array.isArray(errors) && 0 < errors.length) {
      ...
      const err: any = new Error('MercadoBitcoinSDK: graphql: ' +
  ...
  // The argument is the entity OPTIONS object (passed to the entity
  // constructor as entopts), not initial entity data.
  Candle(entopts?: Record<string, any>) {
    const self = this
    return new CandleEntity(self, entopts)
  }
  ...
  // The argument is the entity OPTIONS object (passed to the entity
  // constructor as entopts), not initial entity data.
  DepositAddress(entopts?: Record<string, any>) {
    const self = this
    return new DepositAddressEntity(self, entopts)
  }
  ...
  // The argument is the entity OPTIONS object (passed to the entity
  // constructor as entopts), not initial entity data.
  OrderBook(entopts?: Record<string, any>) {
    const self = this
    return new OrderBookEntity(self, entopts)
  }
  ...
  // The argument is the entity OPTIONS object (passed to the entity
  // constructor as entopts), not initial entity data.
  Ticker(entopts?: Record<string, any>) {
    const self = this
    return new TickerEntity(self, entopts)
  }
  ...
  // The argument is the entity OPTIONS object (passed to the entity
  // constructor as entopts), not initial entity data.
  Trade(entopts?: Record<string, any>) {
    const self = this
    return new TradeEntity(self, entopts)
  }
  ...
  // The argument is the entity OPTIONS object (passed to the entity
  // constructor as entopts), not initial entity data.
  Withdrawal(entopts?: Record<string, any>) {
    const self = this
    return new WithdrawalEntity(self, entopts)
  }
